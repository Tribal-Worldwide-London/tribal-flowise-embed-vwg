        ...
        <div class="relative w-full my-6 max-w-3xl mx-4">
          ...
          >
            <div class="flex items-center justify-between p-[33px] pb-[24px] rounded-t-[16px]">
              <span class="whitespace-pre-wrap max-w-full text-[20px]" style={{
                'font-weight': 300, 
                'font-family': 'vw-text'
              }}>Provide additional feedback</span>
              <button
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M19.5831 5.441L18.6411 4.5L12.056 11.1067L5.441 4.5L4.5 5.441L11.115 12.0477L4.51579 18.6215L5.45679 19.5625L12.056 12.9887L18.6427 19.5826L19.5847 18.6416L12.997 12.0477L19.5831 5.441Z" fill="#001E50"/>
                </svg>
              </button>
            </div>
